...
**Upload size.** There is no size check in the browser — every file is sent, and
Supabase Storage decides whether to accept it. If it refuses one, the modal says
